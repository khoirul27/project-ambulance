                                ...
                                <div class=" header-text">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" name="foto_ambulance" type="file"
                                                id="formFileMultiple" multiple>
                                        </div>
                                        <div class="mt-3 col-6">
                                            <label for="formFileMultiple" class="form-label text-light">No Telfon
                                                :</label>
                                    ...
                                    <button class="btn btn-danger mt-3" name="kirim" type="submit">kirim</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <tbody>
                                    <?php foreach ($output as $id_ambulance) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="foto_ambulance/<?= $id_ambulance['foto_ambulance'] ?>"
                                                    style="width: 150px;">
                                            </td>
                                            <td>
                                                <a href="_data_ambulance.php?hapus=<?= $id_ambulance['foto_ambulance']; ?>"
                                                    onclick="return confirm('yakin mo hapus')">
                                                    <button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                                                <a href="edit_ambulance.php?id_ambulance=<?= $id_ambulance['id_ambulance'] ?>"
                            ...
                            <button class="btn btn-secondary"><a href="export_ambulance.php">Export data</a></button>
                        </div>
                    </div>
                </div>
            </div>
